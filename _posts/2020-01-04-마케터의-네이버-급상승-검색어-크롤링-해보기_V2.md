...
버전을 확인 하였으니 이제 Chrome 드라이버 사이트에 접속하여 자신의 버전에 적합한 드라이버를 다운 받아 보겠습니다. <a href="https://sites.google.com/a/chromium.org/chromedriver/downloads" target="blank">[Chrome 드라이버 다운로드 사이트 접속]</a>
